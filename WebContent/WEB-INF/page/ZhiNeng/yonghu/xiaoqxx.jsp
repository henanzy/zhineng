...
var list;
$.ajax({
		url : "<%=basePath%>yhInfo/find.action", 
		async : false,
		dataType : "json",
		data : {
    ...
    <div id="" class="clearfix">
                        ...
                        <table class="mws-table" >
                            <thead >
                                <tr>
                                    ...
                                    <th class="table-th-css">联系人电话</th>
                                    <th class="table-th-css">能耗单价</th>
                                    <th class="table-th-css">面积单价1</th>
                                    <th class="table-th-css">面积单价2</th>
                                    <th class="table-th-css">换热站</th>
                                    <th class="table-th-css">经度</th>
                                    <th class="table-th-css">纬度</th>
                                    <th class="table-th-css">管理处</th>
        ...
        <div id="increase_word">
			<div class="mws-panel grid_4"
				...
				<div class="mws-panel-header">
					<span class="mws-i-24 i-pencil">新增小区</span> <span class="close"></span>
				</div>
				<div class="mws-panel-body" style="height: 500px;">
					<form class="mws-form" action="InsertXq.action" method="post">
						...
						<div class="mws-form-row">
								...
								<div class="mws-form-item large">
									<input type="text" class="mws-textinput increase_word_input" 
										name="LxrName" value="" autofocus="autofocus" />
								</div>
						</div>
						<div class="mws-form-row">
								<label>&emsp;联系人电话：</label>

								<div class="mws-form-item large">
									<input type="text" class="mws-textinput increase_word_input" 
										name="LxrPhone" value="" autofocus="autofocus" />
								</div>
						</div>
						<div class="mws-form-row">
								<label>&emsp;能耗单价：</label>

								<div class="mws-form-item large">
									<input type="text" class="mws-textinput increase_word_input" 
										name="NHPrice" value="" autofocus="autofocus" />
								</div>
						</div>
							<div class="mws-form-row">
								<label>&emsp;面积单价1：</label>

								<div class="mws-form-item large">
									<input type="text" class="mws-textinput increase_word_input" 
										name="AreaPrice1" value="" autofocus="autofocus" />
								</div>
							</div>	
									
							<div class="mws-form-row">
								<label>&emsp;面积单价2：</label>

								<div class="mws-form-item large">
									<input type="text" class="mws-textinput increase_word_input" 
										name="AreaPrice2" value="" autofocus="autofocus" />
								</div>
							</div>
							...
							<div class="mws-form-row">
								...
								<div class="mws-form-item large">
									<input type="text" class="mws-textinput increase_word_input" 
										name="Jd" value="" autofocus="autofocus" />
								</div>
							</div>
							<div class="mws-form-row">
								<label>&emsp;纬度：</label>
								...
								<div class="mws-form-item large">
									<input type="text" class="mws-textinput increase_word_input" 
										name="Wd" value="" autofocus="autofocus" />
								</div>
							</div>
							<div class="mws-form-row">
								<label>&emsp;管理处：</label>

								<div class="mws-form-item large">
									<input type="text" class="mws-textinput increase_word_input" 
										name="Place" value="" autofocus="autofocus" />
								</div>
							</div>
		...
		<div id="change_word">
			<div class="mws-panel grid_4"
				style="width: 400px; min-width: 550px; margin: 20px 30%;">
				<div class="mws-panel-header">
					<span class="mws-i-24 i-pencil">修改小区</span> <span class="close"></span>
				</div>
				<div class="mws-panel-body" style="height: 500px;">
					<form class="mws-form" action="UpdateXq.action" method="post">
						<div class="mws-form-inline">
...
<script type="text/javascript" src="../js/xqxx.js"></script>
