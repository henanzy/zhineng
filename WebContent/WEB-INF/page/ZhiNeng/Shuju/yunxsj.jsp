...
<body>
	<div id="" class="clearfix">
		...
		<div class="mws-report-container clearfix">
			...
			<p class="mws-report" href="#" style="font-size: 14px; height:100px !important;">
				...
				<span class="mws-report-content"> <span
					...
					<label for="readMTime">室内温度:</label>
						<input type="text" name="valTemp" size="5px" id="snwd_start"
						value="" /> ℃ — <input type="text" name="valTemp" size="5px"
						id="snwd_end" value="" /> ℃ &nbsp;&nbsp;&nbsp; 
						
						<label
						for="readMTime">管道温度:</label> <input type="text" name="valTemp"
						size="5px" id="gdwd_start" value="" /> ℃ — <input type="text"
						name="valTemp" size="5px" id="gdwd_end" value="" /> ℃
						&nbsp;&nbsp;&nbsp; 
						
						
						<label for="readMTime">阀门开度:</label> <input
						type="text" name="valTemp" size="5px" id="fmkd_start" value="" />
						% — <input type="text" name="valTemp" size="5px" id="fmkd_end"
						value="" /> %
