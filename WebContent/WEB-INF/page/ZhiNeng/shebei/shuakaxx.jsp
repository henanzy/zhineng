...
<script type="text/javascript" src="../js/skxx.js"></script>
...
<body>
    <div id="" class="clearfix">
     	  	...
     	  	<div class="mws-panel grid_8" >
                    ...
                    <div id="shuaka_table_body" class="mws-panel-body" style="width:99.5%; height:580px; overflow:auto;">

                        <table class="mws-table" style="width:1600px;">
                            <thead >
                                <tr>
                                	<th></th>
                                    <th class="table-th-css">刷卡器ID</th>
                                    <th class="table-th-css">所属集中器ID</th>
                                    <th class="table-th-css">通讯状态</th>
                                    <th class="table-th-css">小区名称</th>
                                    <th class="table-th-css">安装位置</th>
                                    <th class="table-th-css">备注</th>
                                </tr>
                            </thead>
                            <tbody id="shuaka_body">
