...
<body>
	...
	<script>
		...
		$(".kfgl").click(function(){
			window.location.href = "http://192.144.169.217:8090/kefu/user/home.action";
		});
		$(".nyzgl").click(function(){
			window.location.href = "http://192.144.169.217:8090/xingxhrz/user/home.action";
		});
		$(".rbjc").click(function(){
			/* anim(); */
			window.location.href = "http://192.144.169.217:8090/rebiao/user/home.action";
		});
		$(".nhjk").click(function(){
		...
		$(".nhfx").click(function(){
			window.location.href = "http://192.144.169.217:8090/jfgl/user/home.action";
		});
		$(".jfgl").click(function(){
			window.location.href = "<%=basePath%>user/home.action?fl=nhfx";
		});
		$(".czrz").click(function(){
		...
		$(".xtsz").click(function(){
			window.location.href = "<%=basePath%>user/home.action?fl=xtsz";
		});
