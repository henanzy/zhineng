...
//  表格
	...
	function jsArrChange(json){
		for (var i = 0 ; i < json.length ; i ++) {
			...
			arr1[2] = json[i].LxrName;
			arr1[3] = json[i].LxrPhone;
			arr1[4] = json[i].NHPrice;
			arr1[5] = json[i].AreaPrice1;
			arr1[6] = json[i].AreaPrice2;
			arr1[7] = json[i].HESName;
			arr1[8] = json[i].Jd;
			arr1[9] = json[i].Wd;
			arr1[10] = json[i].Place;
